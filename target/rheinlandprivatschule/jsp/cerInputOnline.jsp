        ...
        if(cmd!=null){
            ...
            if(ndg<60){
                ...
                if(id!=null){
                    ...
                    courseid =va;
                    int chk=cdb.addCertificate(u.getUserID(),va,hv,tp,lv,ws,mp,fs,ndg, MyDate.getCurrentSQLDate(),loginuser.getUserID());
                    ...
                    String err="Es ist nicht möglich.";
                    session.setAttribute("err",err);
                    session.setAttribute("lin","showStudentPreciseD?userid="+u.getUserID());
                    response.sendRedirect("error");
                }
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="wrapper" style="padding-left: 17.5%; padding-right: 17.5%;">
                    ...
                    <div class="row">
                        <form style="width: 100%;" name="form1" method="post" action="verifyCertOnline">
