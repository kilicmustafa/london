...
<head>
    ...
    <script>
        ...
        function telephone(){
            window.location="consultantStudentTelephoneFormInt?consultantid="+document.form1.consultantidS.value+"&studentID="+document.form1.studentidm.value;
            //window.location="driveControler.jsp?folder="+document.form1.f.value+"&myPath="+document.form1.p.value;
        }
        function active(){
            window.location="consultantTelephoneListe?consultantid="+document.form1.consultantidS.value;
            //window.location="driveControler.jsp?folder="+document.form1.f.value+"&myPath="+document.form1.p.value;
        }
...
<%
    ...
    if(werbung!=null){
        ...
        v=studentDB.getAllStudentTelephoneInterested(consultantid);
        studentM=studentDB.getMinStudentIDInterested(consultantid);
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="wrapper" style="padding-left: 17.5%; padding-right: 17.5%;">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="wrapper" style="margin-bottom: 5px; float:right;">
                                ...
                                <a style="margin-right: 5px;" class="btn btn-primary" href="#" onclick="active()">Aktiv</a>
                    ...
                    <div class="row">
                        <form name="form1" method="post" action="updateConsultant" style="width: 100%;" onSubmit="MM_validateForm('txtFirstName','','R','txtLastName','','R','txtBirthPlace','','R','txtNationality','','R','txtAddress','','R','txtPostCode','','RisNum','txtCity','','R','txtCountry','','R','txtHomeNo','','RisNum','txtMobileNo','','RisNum','txtEmail','','RisEmail','txtLoginName','','R','txtPassword','','R');return document.MM_returnValue">
                                ...
                                <tr>
                                    <td height="30" colspan="2" bgcolor="#FFFFFF"><table width="100%"  border="0" cellspacing="1" cellpadding="1">
                                        ...
                                        <tr bgcolor="#405579">
                                            ...
                                            <td width="26%" bgcolor="657A9A"><font color="#ffffff" size="2"><B>Name</B></font></td>
                                        ...
                                        <tr bgcolor="AEBACD">
                                            ...
                                            <td height="6" bgcolor="AEBACD"><input name="studentS" type="hidden" id="studentS" value="<%=werbungStudent.getStudentID()%>">
                                                <font size="2" color="#000033"><font size="2" color="#000033"><a href="consultantStudentUpdateForm?consultantid=<%=werbungStudent.getConsultantID()%>&studentID=<%=werbungStudent.getStudentID()%>"><%=werbungStudent.getFirstName()%> </a><font size="2" color="#000033"><font size="2" color="#000033"><a href="consultantStudentUpdateForm?consultantid=<%=werbungStudent.getConsultantID()%>&studentID=<%=werbungStudent.getStudentID()%>"><%=werbungStudent.getLastName()%></a></font></font></font></font></td>
                                        ...
                                        <tr bgcolor="AEBACD">
                                            ...
                                            <td width="4%" height="6" bgcolor="AEBACD">&nbsp;</td>
