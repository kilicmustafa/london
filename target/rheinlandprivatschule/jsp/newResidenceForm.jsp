...
<%
    ...
    residence=(Residence)session.getAttribute("newresidence");
    session.setAttribute("newresidence",null);
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="wrapper" style="padding-left: 17.5%; padding-right: 17.5%;">
                    ...
                    <div class="row">
                        <form style="width: 100%;" name="form1" method="post" action="registerResidence" onSubmit="MM_validateForm('txtAddress','','R','txtPostCode','','RisNum','txtCity','','R','txtCountry','','R','txtHomeNo','','NisNum','txtMobileNo','','NisNum','txtEmail','','NisEmail');return document.MM_returnValue">
                            <table width="100%" height="443" border="0" cellpadding="1" cellspacing="1">
                                <tr>
                                    <th colspan="2" height="17" bgcolor="657A9A"><b><font color="#FFFFFF">Neue Wohnung </font></b></th>
                                </tr>
                                <tr>
                                    <td height="24" colspan="2" bgcolor="657A9A"><strong><font color="#FFFFFF" size="2">Wohnungsinformationen</font></strong></td>
                                </tr>
                                <tr>
                                    <td height="24" bgcolor="657A9A"><strong><font color="#FFFFFF" size="2">Bezeichnung</font></strong></td>
                                    <td height="24" bgcolor="AEBACD"><input name="txtMark" type="text" id="txtMark" value="<%=mark%>"></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td width="26%" height="24" bgcolor="657A9A"><b><font color="#FFFFFF" size="2">Gr&ouml;&szlig;e</font></b></td>
                                    <td width="74%" height="24" bgcolor="AEBACD"><font color="#000033">
                                        <input name="txtSize" type="text" id="txtSize" value="<%=size%>">
                                    </font></td>
                                </tr>
                                <tr>
                                    <td width="26%" height="24" bgcolor="657A9A"><b><font color="#FFFFFF" size="2">Warmmiete (Mieter)</font></b></td>
                                    <td width="74%" height="24" bgcolor="AEBACD"><font color="#000033">
                                        <input name="txtRent" type="text" id="txtRent" value="<%=rent%>">
                                    </font></td>
                                </tr>
                                <tr>
                                    <td height="24" bgcolor="657A9A"><strong><font color="#FFFFFF" size="2">Kation (Mieter) </font></strong></td>
                                    <td height="24" bgcolor="AEBACD"><input name="txtKation" type="text" id="txtKation" value="<%=kation%>"></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td height="24" colspan="2" bgcolor="657A9A"><strong><font color="#FFFFFF" size="2">Vermietersinformationen</font></strong></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td height="7" bgcolor="657A9A"><strong><font color="#FFFFFF" size="2">Warmmiete (Vermieter) </font></strong></td>
                                    <td height="7" bgcolor="AEBACD"><input name="txtVWMiete" type="text" id="txtVWMiete" value="<%=vwarmiete%>"></td>
                                </tr>
                                <tr>
                                    <td height="7" bgcolor="657A9A"><font size="2" color="#FFFFFF"><b>Nebenkosten (Mieter &amp; Vermieter) </b></font></td>
                                    <td height="7" bgcolor="AEBACD"><input name="txtAddCost" type="text" id="txtAddCost" value="<%=addcosts%>"></td>
                                </tr>
                                <tr>
                                    <td height="7" bgcolor="657A9A"><strong><font color="#FFFFFF" size="2">Kation (Vermieter) </font></strong></td>
                                    <td height="7" bgcolor="AEBACD"><input name="txtVKation" type="text" id="txtVKation" value="<%=vkation%>"></td>
                                </tr>
                                <tr>
                                    <td height="7" bgcolor="657A9A"><strong><font color="#FFFFFF" size="2">Kation Bezahlt </font></strong></td>
                                        ...
                                        <select name="selMonth">
                                            <%
                                                ...
                                                for(int ii=0;ii<vtemp.size();ii++)
                                                {
                                                    ...
                                                    if(temps.equalsIgnoreCase(paidmonth))
                                                    {
                                            %>
                                ...
                                <tr>
                                    ...
                                    <td width="74%" height="7" bgcolor="AEBACD"><input class="btn btn-primary" type="submit" name="Submit" value="Hinzuf&uuml;gen">
                                    </td>
                                </tr>
                            </table>
                        </form>
