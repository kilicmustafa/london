...
<%
    ...
    if(werbung!=null){
        ...
        v=studentDB.getAllStudentInterested();
        studentM=studentDB.getMinInterested();
                                    ...
                                    <td height="30" colspan="2" bgcolor="#FFFFFF"><table width="100%"  border="0" cellspacing="1" cellpadding="1">
                                        ...
                                        <tr bgcolor="AEBACD">
                                            ...
                                            <td height="6" bgcolor="AEBACD"><input name="studentS" type="hidden" id="studentS" value="<%=werbungStudent.getStudentID()%>">
                                                <font size="2" color="#000033"><font size="2" color="#000033"><a href="messeInterestedStudent?studentID=<%=werbungStudent.getStudentID()%>"><%=werbungStudent.getFirstName()%> </a><font size="2" color="#000033"><font size="2" color="#000033"><a href="messeStudentUpdateForm?messeid=<%=werbungStudent.getMesseID()%>&studentID=<%=werbungStudent.getStudentID()%>"><%=werbungStudent.getLastName()%></a></font></font></font></font></td>
