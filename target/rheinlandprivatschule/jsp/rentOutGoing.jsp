...
<head>
    ...
    <script>
        function registerRentIncoming(){
            window.location="registerRentOutGoing?residenceid="+document.form1.residenceid.value;
        }
...
<%
    ...
    try{
        ...
        rentin=rdb.getRentOut(residenceidN, currentmonthN, currentyearN);
        if(residence!=null){
        ...
        rent=residence.getVermieterWarmMiete() - rentin.getAmountPaid();
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="wrapper" style="padding-left: 17.5%; padding-right: 17.5%;">
                    ...
                    <div class="row">
                        <form style="width: 100%" name="form1" method="post" action="registerRentOutGoing" onSubmit="MM_validateForm('txtFirstName','','R','txtLastName','','R','txtBirthPlace','','R','txtNationality','','R','txtAddress','','R','txtPostCode','','RisNum','txtCity','','R','txtCountry','','R','txtHomeNo','','NisNum','txtEmail','','NisEmail','txtLoginName','','R','txtPassword','','R');return document.MM_returnValue">
                            <table width="100%" height="290" border="0" cellpadding="1" cellspacing="1">
                                ...
                                <tr>
                                    ...
                                    <td height="11" bgcolor="AEBACD"><font color="#000033">
                                        ...
                                        <input type="hidden" input name="txtBalance" type="text" id="txtBalance" value="<%=balance%>">
                                    </font></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td width="74%" height="30" bgcolor="AEBACD">
                                        ...
                                        <input type="hidden" input name="residenceid" type="text" id="residenceid" value="<%=residence.getResidenceID()%>" >
                                        <input type="hidden" input name="deleteid" type="text" id="deleteid" value="<%=delete%>" >
