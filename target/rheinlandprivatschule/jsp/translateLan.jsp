...
<%
    ...
    if(sprach!=null){
        ...
        Vector tv=(Vector)session.getAttribute("vocal");
        session.setAttribute("vocal",tv);
        Vector tvr=vdb.getAvailableWordForTan(tv,Integer.parseInt(sprach));
        session.setAttribute("vocalr",tvr);
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="wrapper" style="padding-left: 17.5%; padding-right: 17.5%;">
                    ...
                    <div class="row">
                        <form name="form1" method="post" action="translateLan" onSubmit="MM_validateForm('txtName','','R','txtAddress','','R','txtTelephone','','R','txtPostCode','','RisNum','txtCity','','R','txtCountry','','R','txtEmail','','RisEmail');return document.MM_returnValue">
                            <table width="100%" border="0" cellpadding="1" cellspacing="1">
                                ...
                                <tr>
                                    ...
                                    <td width="75%" bgcolor="AEBACD" height="28">
                                        <input style="width: 100%;" type="submit" name="Submit" value="OK" >
                                    </td>
                                </tr>
                            </table>
                        </form>
