        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="wrapper" style="padding-left: 17.5%; padding-right: 17.5%;">
                    ...
                    <div class="row">
                        <form name="form1" style="width: 100%;" method="post" action="bookList">
                            <table width="100%" border="0" height="120">
                                <tr>
                                    <td height="100" valign="top">                        <table width="100%" border="0" cellpadding="1" cellspacing="1">
                                        <tr bgcolor="657A9A">
                                            <td height="22" colspan="2"><div align="center"><b><font color="#FFFFFF">B&uuml;cher</font></b></div></td>
                                        </tr>
                                        <tr bgcolor="657A9A">
                                            <td bgcolor="657A9A" height="22" width="15%"><div align="left"><font color="#FFFFFF"><b><font size="2">Stufe</font></b></font></div></td>
                                            <td bgcolor="AEBACD" height="22" width="85%"><select name="selStufe" onChange="su()">
                                                <%
                                                    if(b==0)
                                                    {
                                                %>
                                        ...
                                        <tr bgcolor="AEBACD">
                                            <td height="6" colspan="2"><font size="2" color="#000033"><a href="eingang.jsp?bidid=<%=bu.getBookID()%>"><%=bu.getBookName()%></a></font></td>
                                        </tr>
                                        <%
                                            }
                                        %>
