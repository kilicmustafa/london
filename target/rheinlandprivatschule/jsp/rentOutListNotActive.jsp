...
<head>
    ...
    <script>
        ...
        function notactive() {
            window.location = "rentOutListNotActive.jsp";
        }

        function active() {
            window.location = "rentOutList.jsp";
        }


        function newresidence() {
            window.location = "newResidenceForm.jsp";
        }

        function sc() {
            document.form1.action = "adminUserList.jsp?cmd=set";
            document.form1.submit();
        }

        function composeMail() {
            document.form1.action = "mailComposer.jsp";
            document.form1.submit();
        }
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="wrapper" style="padding-left: 17.5%; padding-right: 17.5%;">
                    ...
                    <div class="row">
                        <form name="form1" method="post" action="mieterList1" onSubmit="MM_validateForm('too','','R','subject','','R');return document.MM_returnValue">
...
//for(int j=0;j<u.size();j++)
                                                {
                                                    ...
                                                    //{
                                                    //Residence res=(Residence)u.elementAt(j);
                                            %>
                                            <tr bgcolor="AEBACD">
