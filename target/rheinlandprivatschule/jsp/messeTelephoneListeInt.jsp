...
<head>
    ...
    <script>
        ...
        function telephone(){
            window.location="messeStudentTelephoneFormInt?messeid="+document.form1.messeidS.value+"&studentID="+document.form1.studentidm.value;
            //window.location="driveControler.jsp?folder="+document.form1.f.value+"&myPath="+document.form1.p.value;
        }
        function active(){
            window.location="messeTelephoneListe?messeid="+document.form1.messeidS.value;
            //window.location="driveControler.jsp?folder="+document.form1.f.value+"&myPath="+document.form1.p.value;
        }
...
<%
    ...
    if(werbung!=null){
        ...
        v=studentDB.getAllStudentTelephoneInterested(messeid);
        studentM=studentDB.getMinStudentIDInterested(messeid);
                                    ...
                                    <td height="30" colspan="2" bgcolor="#FFFFFF"><table width="100%"  border="0" cellspacing="1" cellpadding="1">
                                        ...
                                        <tr bgcolor="AEBACD">
                                            ...
                                            <td height="6" bgcolor="AEBACD"><input name="studentS" type="hidden" id="studentS" value="<%=werbungStudent.getStudentID()%>">
                                                <font size="2" color="#000033"><font size="2" color="#000033"><a href="messeStudentTelephoneFormInt?messeid=<%=werbungStudent.getMesseID()%>&studentID=<%=werbungStudent.getStudentID()%>"><%=werbungStudent.getFirstName()%> </a><font size="2" color="#000033"><font size="2" color="#000033"><a href="messeStudentUpdateForm?messeid=<%=werbungStudent.getMesseID()%>&studentID=<%=werbungStudent.getStudentID()%>"><%=werbungStudent.getLastName()%></a></font></font></font></font></td>
