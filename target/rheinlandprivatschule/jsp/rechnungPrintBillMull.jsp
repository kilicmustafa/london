            ...
            <table width="100%" border="0" height="895">
                <tr>
                    ...
                    <td width="52%" height="10">
                        <div align="right"><b><font size="3"><%=place.getFirmaName()%></font></b></div>
                    </td>
                </tr>
                <tr>
                    <td width="52%" height="10">
                ...
                <tr>
                    ...
                    <td width="52%"><div align="right"><font size="2">e-Mail:<%=place.getPlaceEmail()%></font></div></td>
                </tr>
                <tr>
                    ...
                    <td width="52%"><div align="right"><font size="2"><%=place.getBillURL()%></font></div></td>
                </tr>
                <tr>
