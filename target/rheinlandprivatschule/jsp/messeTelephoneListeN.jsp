...
<head>
    ...
    <script>
        ...
        function telephone(){
            window.location="messeStudentTelephoneFormN?messeid="+document.form1.messeidS.value+"&studentID="+document.form1.studentidm.value;
...
<%
    ...
    if(werbung!=null){
        ...
        v=studentDB.getAllStudentTelephoneN(messeid);
        studentM=studentDB.getMinStudentIDN(messeid);
