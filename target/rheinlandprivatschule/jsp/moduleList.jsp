...
<head>
    ...
    <title>:: Module Kategorie Liste ::</title>
            ...
            <div class="container-fluid">
                ...
                <div class="wrapper" style="padding-left: 17.5%; padding-right: 17.5%;">
                    ...
                    <div class="row" style="margin-bottom: 15px;">
                        <a style="margin-right: 5px;" class="btn btn-primary" href="newModule">Neue Module</a>
                            ...
                            <table width="100%" border="0" cellpadding="1" cellspacing="1">
                                <tr bgcolor="657A9A">
                                    <td height="22" bgcolor="657A9A">
                                        <div align="center"><b><font color="#FFFFFF">Module  Liste </font></b></div>
                                    </td>
                                </tr>
                                <c:forEach items="${moduleList}" var="module">
                                    <tr bgcolor="AEBACD">
                                        <td height="6" bgcolor="AEBACD"><font size="2" color="#000033"><a href="moduleView?id=${module.moduleID}">${module.moduleName}</a></font></td>
                                    </tr>
                                </c:forEach>
                                <tr bgcolor="AEBACD">
