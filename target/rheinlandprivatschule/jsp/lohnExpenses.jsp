                            ...
                            <table width="100%" border="0" cellpadding="1" cellspacing="1">
                                <tbody><tr>
                                    <td height="143" valign="top"><table width="100%" border="0" height="160" cellpadding="1" cellspacing="1">
                                        ...
                                        <tr bgcolor="657A9A">
                                            <td height="23" colspan="2"><div align="center"><font size="3" color="#FFFFFF"><b>Löhne Ausrechnen </b></font></div></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr bgcolor="AEBACD">
                                            <td height="24" colspan="2"><font size="2" color="#FFFFFF">&nbsp;</font>
                                                <input class="btn btn-primary" type="submit" name="Submit" value="Löhne Ausrechnen">
                                                <input name="cmd" type="hidden" value="cmd"></td>
                                        </tr>
                                        </tbody></table></td>
                                </tr>
                                <tr>
                                    <td bgcolor="657A9A" height="17"><div align="center"><font size="3" color="#FFFFFF"><b>Löhne Ausrechnen Übersicht</b></font></div></td>
                                </tr>
                                <tr>
                                    <td valign="top"><table width="100%" border="0" cellpadding="1" cellspacing="1">
                                        <tbody><tr>
                                            <td height="20" bgcolor="657A9A"><font color="#FFFFFF" size="3"><b>Löhne Ausrechnen Bei Lehrer/in </b></font>
                                        ...
                                        <tr bgcolor="AEBACD">
                                            <td bgcolor="657A9A"><strong><font color="#FFFFFF" size="3"><b>Löhne Ausrechnen</b></font> <font size="3" color="#FFFFFF">Bei Kurse </font></strong></td>
                                        </tr>
                                        <tr bgcolor="AEBACD">
