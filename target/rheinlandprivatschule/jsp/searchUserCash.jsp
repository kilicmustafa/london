        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="wrapper" style="padding-left: 17.5%; padding-right: 17.5%;">
                    ...
                    <div class="row">
                        <form style="width: 100%;" name="form1" method="post" action="showUserCash" onsubmit="MM_validateForm('tranNo','','NisNum');return document.MM_returnValue">
                            <table width="100%" border="0" height="270" cellpadding="1" cellspacing="1">
                                ...
                                <tr>
                                    <td height="25" bgcolor="657A9A"><b><font size="2" color="#FFFFFF">Schule Name</font></b></td>
                                    <td height="25" bgcolor="AEBACD">
                                ...
                                <tr>
                                    <td width="24%" height="25" bgcolor="657A9A"><b><font size="2"><b><font color="#FFFFFF">Art der Bezahlung</font></b></font></b></td>
