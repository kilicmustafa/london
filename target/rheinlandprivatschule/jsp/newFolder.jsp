...
<%
    ...
    try{
        ...
        if(txt!=null){
            String path=(String)session.getAttribute("tp");
            txt=fm.properName(txt);
            String tpath=path+"/"+txt;
            java.io.File f=new java.io.File(tpath);
            link="driveControler?folder="+txt+"&myPath="+path;
            f.mkdir();

        }else{
            String path = request.getParameter("myPath");
            session.setAttribute("tp",path);
        }
    }catch(Exception e){
    }
%>
                            ...
                            <table width="100%" border="0" cellspacing="1" cellpadding="1" height="79">
                                <tr>
                                    <td valign="top" bgcolor="657A9A" colspan="2" height="16">
                                        <p><font size="2"><b><font color="#FFFFFF">Ordener Name</font></b></font></p>
                                    </td>
                                </tr>
                                ...
                                <tr bgcolor="AEBACD">
                                    <td valign="top" height="30">
                                        <input class="btn btn-primary" type="submit" name="Submit" value="Neue Ordner">
