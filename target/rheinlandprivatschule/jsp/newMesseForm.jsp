        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="wrapper" style="padding-left: 17.5%; padding-right: 17.5%;">
                    ...
                    <div class="row">
                        <form style="width: 100%;" name="form1" method="post" action="registerMesse" onSubmit="MM_validateForm('txtCity','','R','txtCountry','','R','txtUser','','R','txtOrg','','R');return document.MM_returnValue">
                            <table width="100%" height="136" border="0" cellpadding="1" cellspacing="1">
                                <tr>
                                    <th colspan="2" height="17" bgcolor="657A9A"><b><font color="#FFFFFF">Messe
