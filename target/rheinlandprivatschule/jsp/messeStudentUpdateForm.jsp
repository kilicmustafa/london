...
<%
    ...
    try{
        ...
        werbung=studentDB.getStudentMesse(studentID);
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="wrapper" style="padding-left: 17.5%; padding-right: 17.5%;">
                    ...
                    <div class="row">
                        <form style="width: 100%;" name="form1" method="post" action="updateMesseStudent" onSubmit="MM_validateForm('txtFirstName','','R',
				  																							 'txtLastName','','R',
																											 'txtBirthPlace','','R',
																											 'txtNationality','','R',
																											 'txtAddress','','R',
                            ...
                            <table width="100%" height="237" border="0" cellpadding="1" cellspacing="1">
