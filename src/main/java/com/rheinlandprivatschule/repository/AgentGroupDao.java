...
public class AgentGroupDao {
    public boolean addAgentStudent(int agentID,
        ...
        Table table= TableManager.getTable(TableManager.RPS_GROUPSTUDENT);
        try{
    ...
    public Vector<AgentStudent> getAgentStudents(int agentID, int studentStatus){
        Vector<AgentStudent> agnetStudents=new Vector<AgentStudent>();
        Table table=TableManager.getTable(TableManager.RPS_GROUPSTUDENT);
        ...
        try{
            String q="SELECT a."+table.getColumn(0)+",a."
                    ...
                    +group_table.getColumn(0)+"=a."+table.getColumn(2)+" AND b."
                    +group_table.getColumn(1)+"=a."+table.getColumn(1)+" AND b."
                    +group_table.getColumn(2)+"="+studentStatus+" AND a."
    ...
    public Vector<AgentStudent> getAllAgentStudents(){
        Vector<AgentStudent> agnetStudents=new Vector<AgentStudent>();
        Table agent_table=TableManager.getTable(TableManager.RPS_GROUPSTUDENT);
