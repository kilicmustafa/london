...
public class ResidentEntryDao {
    ...
    public int addNewResidentWithoutReference(Resident resident) {
        int newResidentID = 0;
        try {
            ...
            String q = "INSERT INTO " + table.getTableName() + " ("
                    ...
                    + table.getColumn(23)+ ","
                    + table.getColumn(24)+ ","
                    + table.getColumn(25)+ ") VALUES ("
                    + replaceNull(resident.getResidenceID()) + ","
                    ...
                    + replaceNull(resident.getMietStart()) + ","
                    + replaceNull(resident.getMietEnd()) + ","
                    + replaceNull(resident.getMieterCountStart()) + ","
                    + replaceNull(resident.getMieterCountEnd()) + ")";
    ...
    private int addNewResidentByStudentReference(Resident resident) {
        ...
        try {
            ...
            String q = "INSERT INTO " + table.getTableName() + " ("
                    + table.getColumn(0) + ","
                    + table.getColumn(20) + ","
                    + table.getColumn(21) + ") VALUES ('"
                    +resident.getResidenceID()+"','"
                    +resident.isStudent()+"','"
                    +resident.getStudentReference().getUserID()+"')";
            DBHelper.getInstance().updateQuery(q);
        } catch (Exception e) {
            setError(e.toString());
        }
    ...
    public Vector<Resident> getAllResidentWithoutReference(int residenceID) {
        ...
        try {
            String q = "SELECT " + table.getColumn(0) + ","
                    ...
                    + table.getColumn(24) + ","
                    + table.getColumn(25) + ","
                    + table.getColumn(26) + " FROM "
                    + table.getTableName()	+ " WHERE "
                    //+ table.getColumn(20) + "='" + false+ "' AND "
                    + table.getColumn(0) + "=" + residenceID+ " ORDER BY "
                    + table.getColumn(22)+" DESC";
            ResultSet rs = DBHelper.getInstance().executeQuery(q);
            while (rs.next()) {
                ...
                resident.setMietStart(rs.getDate(table.getColumn(22)));
                resident.setMietEnd(rs.getDate(table.getColumn(23)));
                resident.setMieterCountStart(rs.getString(table.getColumn(24)));
                resident.setMieterCountStart(rs.getString(table.getColumn(25)));
                resident.setResidenceID(rs.getInt(table.getColumn(26)));
    ...
    private Resident getResidentWithoutReference(int residentID) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                resident.setMietEnd(rs.getDate(table.getColumn(23)));
                resident.setMieterCountStart(rs.getString(table.getColumn(24)));
                resident.setMieterCountEnd(rs.getString(table.getColumn(25)));
                resident.setResidenceID(rs.getInt(table.getColumn(26)));
    ...
    public int updateResidentWithoutReference(Resident resident) {
        int updateStatus = 0;
        try {
            ...
            String q = "UPDATE " + table.getTableName() + " SET "
                    + table.getColumn(1) + "=" + replaceNull(resident.getUserFirstName()) + ","
                    + table.getColumn(2) + "=" + replaceNull(resident.getUserLastName()) + ","
                    + table.getColumn(3) + "=" + replaceNull(resident.getUserBirthDate()) + ","
                    + table.getColumn(4) + "=" + replaceNull(resident.getUserGender()) + ","
                    + table.getColumn(5) + "=" + replaceNull(resident.getUserBirthPlace()) + ", "
                    + table.getColumn(6) + "=" + replaceNull(resident.getUserNationality()) + ","
                    + table.getColumn(7) + "=" + replaceNull(resident.getUserAddress()) + ","
                    + table.getColumn(8) + "=" + replaceNull(resident.getUserPostCode()) + ","
                    + table.getColumn(9) + "=" + replaceNull(resident.getUserCity()) + ","
                    + table.getColumn(10) + "=" + replaceNull(resident.getUserCountry()) + ","
                    + table.getColumn(11) + "=" + replaceNull(resident.getUserHomePhone()) + ","
                    + table.getColumn(12) + "=" + replaceNull(resident.getUserMobilePhone()) + ","
                    + table.getColumn(13) + "="	+ replaceNull(resident.getUserFax()) + ","
                    + table.getColumn(14) + "="	+ replaceNull(resident.getUserEmail()) + ","
                    + table.getColumn(19) + "="	+ replaceNull(resident.getUserCO()) + ","
                    //	+ table.getColumn(20) + "='" + defaultStudent + "',"
                    //+ table.getColumn(21) + "='" + defaultStudentReference + "',"
                    + table.getColumn(22) + "=" + replaceNull(resident.getMietStart()) + ","
                    + table.getColumn(23) + "=" + replaceNull(resident.getMietEnd()) + ","
                    + table.getColumn(24) + "=" + replaceNull(resident.getMieterCountStart()) + ","
                    + table.getColumn(25)+ "=" 	+ replaceNull(resident.getMieterCountEnd()) + " WHERE "
                    + table.getColumn(26) + "='" + resident.getResidenceID() + "'";
            DBHelper.getInstance().updateQuery(q);
            updateStatus = 1;
        } catch (Exception e) {
            setError(e.toString());
