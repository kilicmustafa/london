...
public class XtraCostDao {

    public int addNewXtraCost(Student student) {
        int chk=0;
        Table table=TableManager.getTable(TableManager.RPS_XTRACOSTS);
        try{
    ...
    public Student getCostStudent(int costID,int studentID) {
        Student student = new Student();
        Table cost_table=TableManager.getTable(TableManager.RPS_TRAN_XTRA);
        try {
    ...
    public Student getXtraCostByStudent(int costID,int studentID) {
        Student student = new Student();
        Table registration_table=TableManager.getTable(TableManager.RPS_TRAN_XTRA);
        try {
