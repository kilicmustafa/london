...
//
    ...
    <tr>
        <td colspan="3" align="left"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Wir
            danken Ihnen f&uuml;r Ihren Auftrag.</font>
            <br>
            <br>
            <br>
            <font size="2" face="Verdana, Arial, Helvetica, sans-serif">Mit freundlichen Gr&uuml;&szlig;en,</font>
            <br>
            <font size="2" face="Verdana, Arial, Helvetica, sans-serif">-Rheinland Privatschule-</font>
            <br>
            <br>
            <br>
            <br>
        ...
        <td colspan="6" align="right"><img width="150" height="166" src="/schuler/createregistrationqr?&courseId=<%=course.getCourseID()%>&studentId=<%=pstudent.getUserID()%>">
        </td>
    </tr>
</table>
</body>
