...
<head>
    ...
    <script>
        ...
        function newstudent(){
            window.location="newConsultantStudentForm?consultantid="+document.form1.txtConsultantid.value;
        }

        function telephone(){
            window.location="consultantTelephoneListe?consultantid="+document.form1.txtConsultantid.value;
        }
        ...
        function deleteConsultant(consultantid, studentid) {
            if(confirm("Möchten Sie es wirklich löschen?") === true) {
                window.location = "deleteConsultant?consultantid="+consultantid+"&studentid="+studentid;
            }
        }
...
<%
    ...
    if(werbung!=null){
        ...
        v=studentDB.getAllStudentConsultant(consultantid);
                            ...
                            <table width="100%" height="189" border="0" cellpadding="1" cellspacing="1">
                                ...
                                <tr>
                                    ...
                                    <td width="81%" height="30" bgcolor="AEBACD">
                                        ...
                                        <font color="#000033">
                                            <input type="hidden" name="txtConsultantid" value="<%=consultantid%>">
                                        </font>                        </td>
                                </tr>
                                <tr>
                                    <td height="30" colspan="2" bgcolor="#FFFFFF"><table width="100%"  border="0" cellspacing="1" cellpadding="1">
                                        <tr>
                                            <td height="29" colspan="8" bgcolor="657A9A"><div align="center">
                                                <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td colspan="2"><div align="center"><b></b></div>
                                                            <div align="center"><b><font color="#FFFFFF" >Agenturen Liste</font></b></div></td>
                                                    </tr>
                                                    <tr>
                                        ...
                                        <tr bgcolor="#405579">
                                            ...
                                            <td width="30%" bgcolor="657A9A"><font color="#ffffff" size="2"><B>Name</B></font></td>
                                            <td width="25%" height="14" bgcolor="657A9A"><font color="#FFFFFF"><b><FONT size=2>Email</FONT></b></font></td>
                                            <td width="22%" bgcolor="657A9A"><strong><b><font color="#ffffff" size="2">Telephone</font></b></strong></td>
                                            <td colspan="3" bgcolor="657A9A"><strong><font color="#FFFFFF" size="2">Anfang Datum </font></strong></td>
                                            <td colspan="3" bgcolor="657A9A"><strong><font color="#FFFFFF" size="2"></font></strong></td>
                                        </tr>
                                        <tr bgcolor="AEBACD">
                                            <%
                                            ...
                                            <td height="6" bgcolor="AEBACD"><font size="2" color="#000033"><font size="2" color="#000033"><a href="consultantStudentUpdateForm?consultantid=<%=werbungStudent.getConsultantID()%>&studentID=<%=werbungStudent.getStudentID()%>"><%=werbungStudent.getFirstName()%></a><font size="2" color="#000033"><a href="consultantStudentUpdateForm?consultantid=<%=werbungStudent.getConsultantID()%>&studentID=<%=werbungStudent.getStudentID()%>"> </a></font></font></font></td>
                                            ...
                                            <td height="6" colspan="3" bgcolor="AEBACD"><font size="2" color="#000033"><a href="#" onclick="deleteConsultant(<%=werbungStudent.getConsultantID()%>, <%=werbungStudent.getStudentID()%>)">Löschen</a></font></td>
                                        </tr>
                                        <%
                                            }
                                        %>
                                        <tr bgcolor="AEBACD">
                                            ...
                                            <td width="15%" height="6" colspan="2" bgcolor="AEBACD">&nbsp;</td>
                                        </tr>
                                    </table></td>
                                </tr>
                            </table>
