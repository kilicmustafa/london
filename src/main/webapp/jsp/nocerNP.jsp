...
<head>
    ...
    <SCRIPT TYPE="text/javascript">
        function myOpen(){
            window.open("printCertificateNP"); // params and stuff
...
<%
    ...
    if(ndgT<60){
        ...
        int chk=cdb.addCertificateNP(u.getUserID(),Integer.parseInt(courseid),hvT,tpT,lvT,wsT,mpT,fsT,ndgT, MyDate.getCurrentSQLDate(),loginuser.getUserID());
