...
<%
    ...
    if (bamfnr == null){
        bamfnr = "";}
    nochHours=600; //Integer.parseInt(totalHours)-completedHours;
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="wrapper" style="padding-left: 17.5%; padding-right: 17.5%;">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="wrapper" style="margin-bottom: 5px; float:right;">
                                ...
                                <a style="margin-right: 5px;" class="btn btn-primary" href="#" onclick="deletecourse('Sind Sie sicher, um Kurs zu loeschen?');return false">Kurs L&ouml;schen</a>
                    ...
                    <div class="row">
                        <table width="100%" border="0" height="725">
                            <tr>
                                <td valign="top">
                            ...
                            <tr>
                                <td height="21" valign="top">
                                    <form style="width: 100%;" name="form2" method="post" action="">
                                        <table width="100%" border="0" cellpadding="1" cellspacing="1">
                                            ...
                                            <tr bgcolor="AEBACD">
                                                <td colspan="7" height="16"><div align="left"><font color="#FFFFFF" size="2"><b> Noch</b></font><font color="#FFFFFF" size="2"><b> <%=nochHours%>   Ust.</b></font><font color="#FF9900" size="2"></font></div>
                                                </td>
                                                <td height="16" colspan="4"><div align="right"><font color="#FFFFFF" size="2"><b><%=bamfnr%></b></font></div></td>
                                            </tr>
                                            <tr bgcolor="657A9A">
                                                <td colspan="11" height="16"><div align="center"><font size="2"><b><font color="#FFFFFF">Kursteilnehmer</font></b></font></div></td>
                                            </tr>
                                            <tr bgcolor="657A9A">
                                                <td width="8%">&nbsp;</td>
                                                <td width="23%">&nbsp;</td>
                                                <td width="14%" height="14"><font size="2" color="#FFFFFF"><b>Summe &nbsp;&nbsp;&nbsp; <%=v.size()%></b></font></td>
                                                <td colspan="8" height="14" bgcolor="657A9A"><div align="right"><font size="2" color="#FFFFFF"></font></div></td>
                                            </tr>
                                            <tr bgcolor="657A9A">
                                                <td width="8%"><div align="center"><font color="#FFFFFF" size="2"><strong>Kundennr.</strong></font></div></td>
                                                <td width="23%"><div align="center"><font color="#FFFFFF" size="2"><strong>email</strong></font></div></td>
                                                <td width="14%" height="14"><div align="center"><font color="#FFFFFF"><b><font size="2">Vorname</font></b></font></div></td>
                                                <td width="14%" height="14" bgcolor="657A9A"><div align="center"><font color="#FFFFFF"><b><font size="2">Nachname </font></b></font></div></td>
                                                <td width="13%" height="14"><font size="2" color="#FFFFFF"><b>Werbung</b></font></td>
                                                <td width="2%"><strong><font color="#FFFFFF" size="2">Int.</font></strong></td>
                                                <td width="7%" height="14"><b><font color="#FFFFFF" size="2">Geb&uuml;hr</font></b></td>
                                                <td width="8%" height="14"><b><font color="#FFFFFF" size="2">Gezahlt</font></b></td>
                                                <td width="7%" height="14"><b><font size="2" color="#FFFFFF">Noch offen </font></b></td>
                                                <td width="4%" height="14" colspan="2"><strong><font color="#FFFFFF" size="2">Anw.</font></strong></td>
                                            </tr>
                                            <%
                                            ...
                                            %>
                                            <tr bgcolor="#9999CC">
                                                <td width="8%"><font size="2" color="#000033" face="Verdana, Arial, Helvetica, sans-serif"><a href="/schuler/showStudentPreciseD?userid=<%=u.getUserID()%>"><%=u.getUserID()%></a></font></td>
                                                <td width="23%"><div align="left"><font size="2" color="#000033" face="Verdana, Arial, Helvetica, sans-serif"><a href="/schuler/showStudentPreciseD?userid=<%=u.getUserID()%>"><%=u.getUserEmail()%></a></font></div></td>
                                                <td width="14%" height="6"><font size="2" color="#000033" face="Verdana, Arial, Helvetica, sans-serif"><a href="/schuler/showStudentPreciseD?userid=<%=u.getUserID()%>"><%=u.getUserFirstName()%></a></font></td>
                                                <td width="14%" height="6"><font size="2" color="#000033" face="Verdana, Arial, Helvetica, sans-serif"><%=u.getUserLastName()%></font></td>
                                                <td width="13%" height="6"><font size="2" color="#000033" face="Verdana, Arial, Helvetica, sans-serif"><%=werbungName%></font></td>
                                                <td width="2%" height="6"><%
                                                    if(bamfnumber!="0"  ){
                                                %>
                                                ...
                                                <td height="6" width="8%"><font size="2" color="#000033" face="Verdana, Arial, Helvetica, sans-serif"><%=cre%></font></td>
                                                <td height="6" width="7%"><font size="2" color="#000033" face="Verdana, Arial, Helvetica, sans-serif"><%=cr.getCourseBalance()%></font></td>
                                                <td width="4%" height="6" colspan="2"><%
                                            ...
                                            <tr bgcolor="AEBACD">
                                                <td width="8%"><font size="2" color="#000033" face="Verdana, Arial, Helvetica, sans-serif"><a href="/schuler/showStudentPreciseD?userid=<%=u.getUserID()%>"><%=u.getUserID()%></a></font></td>
                                                <td width="23%"><font size="2" color="#000033" face="Verdana, Arial, Helvetica, sans-serif"><a href="/schuler/showStudentPreciseD?userid=<%=u.getUserID()%>"><%=u.getUserEmail()%></a></font></td>
                                                <td width="14%" height="6"><font size="2" color="#000033" face="Verdana, Arial, Helvetica, sans-serif"><a href="/schuler/showStudentPreciseD?userid=<%=u.getUserID()%>"><%=u.getUserFirstName()%></a></font></td>
                                                <td width="14%" height="6" bgcolor="AEBACD"><font size="2" color="#000033" face="Verdana, Arial, Helvetica, sans-serif"><%=u.getUserLastName()%></font></td>
                                                <td width="13%" height="6"><font size="2" color="#000033" face="Verdana, Arial, Helvetica, sans-serif"><%=werbungName%></font></td>
                                                <td width="2%" height="6"><%
                                                    if(bamfnumber!="0"){
                                                %>
                                            ...
                                            <tr bgcolor="#3399CC">
                                                ...
                                                <td height="6" width="8%"><font size="2" color="#000033"><%=zahlend%></font></td>
                                                <td height="6" width="7%"><font size="2" color="#000033"><%=active%></font></td>
                                                <td width="4%" height="6" colspan="2">&nbsp;</td>
                                            </tr>
                                        </table>
                                    </form>
                                </td>
                            ...
                            <tr>
                                <td height="312" valign="top"><table width="100%" border="0" cellpadding="1" cellspacing="1">
                                    <tr bgcolor="657A9A">
                                    ...
                                    %>
                                    <tr bgcolor="#3399CC">
                                        <td width="25%" height="6" bgcolor="#3399CC"><font size="2" color="#000033"></font></td>
                                    ...
                                    <tr valign="top">
                                        <td colspan="7" height="25" bgcolor="AEBACD">
                                            <form style="width: 100%;" name="form3" method="post" action="">
