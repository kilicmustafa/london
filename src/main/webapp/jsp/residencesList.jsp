...
<%
    ...
    Vector typeA = new Vector();
    Vector typeB = new Vector();

    for (int i = 0; i < v.size(); i++) {
        Residence r = (Residence) v.get(i);
        if(r.getResidenceType() != null && r.getResidenceType().equalsIgnoreCase("A")) {
            typeA.add(r);
        } else if(r.getResidenceType() != null && r.getResidenceType().equalsIgnoreCase("B")) {
            typeB.add(r);
        }
    }
%>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="wrapper" style="margin-bottom: 5px; float:right;">
                                ...
                                <a style="margin-right: 5px;" class="btn btn-primary" href="#" onclick="newresidence()">Neue Wohnung</a>
                                        ...
                                        <table width="100%" border="0" cellpadding="1" cellspacing="1">
                                            <tr bgcolor="657A9A">
                                                <td colspan="9" height="16">
                                                    <div align="center"><b><font color="#FFFFFF">Gemietete Objekte Wohnungliste </font></b></div>
                                                </td>
                                            </tr>
                                            <tr bgcolor="#405579">
                                                <td width="15%" bgcolor="657A9A"><div align="left"><font color="#FFFFFF" size="2"><b>Bezeichnung</b></font></div></td>
                                                <td width="11%" height="14" bgcolor="657A9A"><font color="#FFFFFF"><b><font size="2">Stadt</font></b></font></td>
                                                <td width="7%" bgcolor="657A9A"><strong><b><font color="#FFFFFF" size="2">Gr&ouml;&szlig;e</font></b></strong></td>
                                                <td width="7%" bgcolor="657A9A"><strong><font color="#FFFFFF" size="2">Miete (Mieter) </font></strong></td>
                                                <td width="10%" bgcolor="657A9A"><strong><font color="#FFFFFF" size="2">Nebenkosten (Mieter &amp; Vermieter)</font></strong></td>
                                                <td width="13%" bgcolor="657A9A"><strong><font color="#FFFFFF" size="2">Z&auml;hlernummer</font></strong></td>
                                                <td width="10%" bgcolor="657A9A"><strong><font color="#FFFFFF" size="2">Vermieter Miete </font></strong></td>
                                                <td width="8%" bgcolor="657A9A"><strong><font color="#FFFFFF" size="2">Vermieter Kation </font></strong></td>
                                                <td width="19%" bgcolor="657A9A"><strong><font color="#FFFFFF" size="2">Vermieter</font></strong></td>
                                            </tr>
                                            <%
                                                for(int i=0;i<typeA.size();i++)
                                                {
                                                    Residence residence=(Residence)typeA.elementAt(i);
                                            ...
                                            <tr bgcolor="AEBACD">
                                                ...
                                                <td width="11%" height="6"><font size="2" color="#000033"><%=residence.getResidenceCity()%></font></td>
                                                ...
                                                <td height="6" bgcolor="AEBACD"><font size="2" color="#000033"><%=MyCurrency.getDisplayString(residence.getResidenceSideCosts())%></font></td>
                                                <td height="6" bgcolor="AEBACD"><font size="2" color="#000033"><%=residence.getResidenceMeterNumber()%></font></td>
                                                <td height="6" bgcolor="AEBACD"><font size="2" color="#000033"><%=MyCurrency.getDisplayString(residence.getVermieterWarmMiete())%></font></td>
                                                <td height="6" bgcolor="AEBACD"><font size="2" color="#000033"><%=MyCurrency.getDisplayString(residence.getVermieterKation())%></font></td>
                                                <td height="6" bgcolor="AEBACD"><font size="2" color="#000033"><%=residenceOwner.getResidenceOwnerCompany()%></font></td>
                                            </tr>
                                ...
                                <tr>
                                    <td width="100%" colspan="5">
                                        <table width="100%" border="0" cellpadding="1" cellspacing="1">
                                            <tr bgcolor="657A9A">
                                                <td colspan="9" height="16">
                                                    <div align="center"><b><font color="#FFFFFF">Eigene Objekte Wohnungliste </font></b></div>
                                                </td>
                                            </tr>
                                            <tr bgcolor="#405579">
                                                <td width="15%" bgcolor="657A9A"><div align="left"><font color="#FFFFFF" size="2"><b>Bezeichnung</b></font></div></td>
                                            ...
                                            <%
                                                ...
                                                {
                                                    Residence residence=(Residence)typeB.elementAt(i);
                                                    int owner=residence.getResidenceOwner();
                                                    residenceOwner = rodb.getResidenceOwner(owner);
