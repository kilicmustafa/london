...
<head>
    ...
    <title>:: Neue angemeldet Sch&uuml;ler/in ::</title>
    <style>
        table tr {
...
<%
    ...
    Place myPlace = (Place) request.getAttribute("myPlace");


    Vector cityV= placeDB.getAllPlaces();
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="wrapper" style="padding-left: 17.5%; padding-right: 17.5%;">
                    ...
                    <div class="row">
                        <form style="width: 100%;" name="form1" method="post" action="showFirstPay" onSubmit="MM_validateForm('tranNo','','NisNum');return document.MM_returnValue">
                            <table width="100%" border="0" height="112" cellpadding="1" cellspacing="1">
                                <tr bgcolor="657A9A">
                                    <td height="23" colspan="2">
                                        <div align="center"><font size="3" color="#FFFFFF"><b>Neue angemeldet Sch&uuml;ler/in</b></font></div>
                                    </td>
                                </tr>
                                <tr>
                                        ...
                                        <select name="selPlace">
                                            ...
                                            <%
                                                for(int h=0;h<cityV.size();h++)	{
                                                    ...
                                                    if(plk.getPlaceID()==myPlace.getPlaceID()){

                                            %>
                                            <option  value="<%=plk.getPlaceID()%>" selected><%=plk.getPlaceName()%></option>
                                            <%
                                            }else{
                                            %>
