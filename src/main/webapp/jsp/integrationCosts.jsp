...
<head>
    ...
    <script>
        ...
        {
            window.location="integrationCostsDetail";
        }
...
<%
    ...
    if(student!=null){
        ...
        xtra = costDB.getXtraCosts(userid);
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="wrapper" style="padding-left: 17.5%; padding-right: 17.5%;">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="wrapper" style="margin-bottom: 5px; float:right;">
                                <a style="margin-right: 5px;" class="btn btn-primary" href="#" onclick="Allstudents()">Alle Sch&uuml;lern</a>
                    ...
                    <div class="row">
                        <form style="width: 100%;" name="form1" method="post" action="registerIntegrationCosts" onSubmit="MM_validateForm('txtDesc','','R',
                            ...
                            <table width="100%" height="206" border="0" cellpadding="1" cellspacing="1">
                                ...
                                <tr bgcolor="657A9A">
                                    <th height="17" colspan="6"><b><font color="#FFFFFF">Fahr kosten
                                ...
                                <tr>
                                    <td height="2" bgcolor="657A9A"><font color="#FFFFFF" size="2"><b>F&uuml;r Modul</b></font></td>
                                    <td height="2" colspan="5" bgcolor="AEBACD"><font color="#000033">
                                        <input type="text" name="txtDesc" value="<%=desc%>">
                                    </font></td>
                                </tr>
                                <tr>
                                    <td height="2" bgcolor="657A9A"><font color="#FFFFFF" size="2"><b>Eingang</b></font></td>
                                    <td height="2" colspan="5" bgcolor="AEBACD"><font color="#000033">
                                ...
                                <tr bgcolor="657A9A">
                                    <td width="19%"><font color="#FFFFFF" size="2"><b>Bericht Nr </b></font></td>
                                    <td width="19%" height="21"><font color="#FFFFFF" size="2"><b>F&uuml;r Module </b></font></td>
                                    <td width="16%" height="21"><font color="#FFFFFF" size="2"><b>EingangDatum</b></font></td>
                                    <td width="15%" height="21"><font color="#FFFFFF" size="2"><b>Eingang</b></font></td>
                                    <td width="15%" height="21"><font color="#FFFFFF" size="2"><b>Ausgang</b></font></td>
                                    <td width="16%" height="21"><font color="#FFFFFF" size="2"><b>Noch offen</b></font></td>
                                </tr>
                                <%
                                    for(int h=0;h<xtra.size();h++)
                                    {

                                        boolean c=true;
                                        Vector xtracost1;

                                        Student stu=(Student)xtra.elementAt(h);
                                        ...
                                        xtracost1 = xtraCostDB.getXtraTran(stu.getResidenceID());
                                ...
                                %>
                                <tr bgcolor="AEBACD">
                                    <td><font size="2" color="#000033"><a href="linkToIntegrationCostBericht?costid=<%=stu.getResidenceID()%>"><%=stu.getResidenceID()%></a></font></td>
                                    <td><font size="2" color="#000033"><a href="showIntegrationCostDetail?courseid=<%=stu.getResidenceID()%>"><%=stu.getUserRemarks()%></a></font></td>
                                    <td><font size="2" color="#000033"><%=MyDate.formateDate(stu.getUserRegDate(),MyDate.NUMERIC,MyDate.DEUTSCH)%></font></td>
                                    <td><font size="2" color="#000033"><%=stu.getUserStundenLohn()%></font></td>
                                    <td><font size="2" color="#000033"><%=pay.getTotalPay()%></font></td>
                                    <td><font size="2" color="#000033"><%=((xtracost.getActualFee()-pay.getTotalPay()))%></font></td>
                                </tr>
                                ...
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                                <td><font size="2" color="#000033"><b><%=MyCurrency.getDisplayString(toge)%></b></font></td>
                                <td><font size="2" color="#000033"><b><%=MyCurrency.getDisplayString(bez)%></b></font></td>
                                <td><font size="2" color="#000033"><b><%=MyCurrency.getDisplayString(nochof)%></b></font></td>
                            </tr>
                            </table>
                        </form>
                    </div>
