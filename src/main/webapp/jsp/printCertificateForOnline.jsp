...
//
                            ...
                            <tr>
                                <td style="float:left;">
                                    <img style="width: 100px; height: 100px;" src="/schuler/createonlineqr?studentId=<%=pstudent.getUserID()%>&certificateId=<%=cer.certificateID%>&type=pure">
                                </td>
                            ...
                            <tr>
                                <td colspan="4" height="21"><p align="center"> <em><%=courseName%> online</em> </p></td>
                            </tr>
                            <tr>
