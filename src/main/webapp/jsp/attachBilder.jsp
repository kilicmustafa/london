                                            ...
                                            <table width="101%" border="0" cellspacing="0" cellpadding="0" height="434">
                                                <tbody><tr>
                                                    <td valign="top" height="488" bgcolor="D9E5F4" width="83%">                <table width="100%" border="0" cellspacing="1" cellpadding="1" height="160">
                                                        ...
                                                        <tr>
                                                            <td colspan="3" valign="top" bgcolor="AEBACD"><form name="form1" method="post" action="/studentBilder/attachBilder" enctype="multipart/form-data">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td valign="top" bgcolor="AEBACD" height="16" colspan="2"><font size="2" color="#000033">${student.userFirstName} ${student.userLastName}</font></td>
                                                        </tr>

                                                        <c:forEach items="${vertrags}" var="pp">
                                                            <tr bgcolor="AEBACD">
                                                                <td valign="top" height="20"><font size="2" color="#000033">${vertrags.indexOf(pp) + 1}</font> </td>
                                                                <td height="20" valign="top"><font size="2" color="#000033"><a href="image?ver=${pp.bildName}">${pp.bildName}</a></font><font size="2" color="#000033" input="" type="hidden">
                                                                    <input type="hidden" name="userids" value="9462">
                                                                </font></td>
                                                                <td width="17%" height="20" colspan="3"><font size="2" color="#000033"><a href="deleteBilder?cmd=${pp.bildID}&ver=${pp.bildName}"> Löschen</a></font></td>
                                                            </tr>
                                                        </c:forEach>
