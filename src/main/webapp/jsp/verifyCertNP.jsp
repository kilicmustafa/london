...
<head>
    ...
    <script>
        ...
        function verify()
        {
            window.location="verifyCertNPAgain?useridS="+document.form1.userid.value
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="wrapper" style="padding-left: 17.5%; padding-right: 17.5%;">
                    ...
                    <div class="row">
                        <form style="width: 100%;" name="form1" method="post" action="nocerNP">
                            <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                ...
                                <tr>
                                    ...
                                    <td width="71%" bgcolor="AEBACD">
                                        <input type="button" name="prufen" value="prüfen" onClick="verify()">
                                        <input type="submit" name="Submit" value="Zertifikat">
                                    </td>
                                </tr>
                            </table>
                        </form>
