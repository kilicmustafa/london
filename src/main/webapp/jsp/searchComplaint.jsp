        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="wrapper" style="padding-left: 17.5%; padding-right: 17.5%;">
                    ...
                    <div class="row">
                        <form style="width: 100%;" name="form1" method="post" action="showComplaint" onSubmit="MM_validateForm('tranNo','','NisNum');return document.MM_returnValue">
                            <table width="100%" border="0" height="112" cellpadding="1" cellspacing="1">
                                <tr bgcolor="657A9A">
                                    <td height="23" colspan="2">
                                        <div align="center"><font size="3" color="#FFFFFF"><b>Beschwerden Ansicht </b></font></div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td height="29" width="76%" bgcolor="AEBACD">
                                        <select name="selC" onChange="if(selectedIndex==2)tranNo.disabled=false;if(selectedIndex==0)tranNo.disabled=true;if(selectedIndex==1)tranNo.disabled=true;if(!tranNo.disabled)tranNo.focus()">
                                            ...
                                            <option value="3">Kunden Nr</option>
                                        </select>
                                    </td>
                                </tr>
                                <tr>
                                    <td height="29" width="24%" bgcolor="657A9A"><font size="2"><b><font color="#FFFFFF">Kunden
                                        Nr</font></b></font></td>
                                    <td height="29" width="76%" bgcolor="AEBACD">
