...
<head>
    ...
    <script>
        ...
        function telephone(){
            window.location="consultantStudentTelephoneFormN?consultantid="+document.form1.consultantidS.value+"&studentID="+document.form1.studentidm.value;
...
<%
    ...
    if(werbung!=null){
        ...
        v=studentDB.getAllStudentTelephoneN(consultantid);
        studentM=studentDB.getMinStudentIDN(consultantid);
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="wrapper" style="padding-left: 17.5%; padding-right: 17.5%;">
                    ...
                    <div class="row">
                        <form name="form1" method="post" style="width: 100%;" action="updateConsultant" onSubmit="MM_validateForm('txtFirstName','','R','txtLastName','','R','txtBirthPlace','','R','txtNationality','','R','txtAddress','','R','txtPostCode','','RisNum','txtCity','','R','txtCountry','','R','txtHomeNo','','RisNum','txtMobileNo','','RisNum','txtEmail','','RisEmail','txtLoginName','','R','txtPassword','','R');return document.MM_returnValue">
                                ...
                                <tr>
                                    <td height="30" colspan="2" bgcolor="#FFFFFF"><table width="100%"  border="0" cellspacing="1" cellpadding="1">
                                        ...
                                        <tr bgcolor="#405579">
                                            ...
                                            <td width="27%" bgcolor="657A9A"><font color="#ffffff" size="2"><B>Name</B></font></td>
                                            <td width="24%" height="14" bgcolor="657A9A"><font color="#FFFFFF"><b><FONT size=2>Email</FONT></b></font></td>
                                            <td width="19%" bgcolor="657A9A"><strong><b><font color="#ffffff" size="2">Telephone</font></b></strong></td>
                                        ...
                                        <tr bgcolor="AEBACD">
                                            ...
                                            <td width="1%" height="6" bgcolor="AEBACD">&nbsp;</td>
                                            <td width="21%" height="6" colspan="2" bgcolor="AEBACD">&nbsp;</td>
                                        </tr>
                                    </table></td>
                                </tr>
                            </table>
