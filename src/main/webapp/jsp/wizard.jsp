    ...
    if(hf!=null){
        ...
        while (e.hasMoreElements())	{
            ...
            try	{
                ...
                String tv= request.getParameter(key);
                if(tv!=null ){
                    if(!tv.equalsIgnoreCase("")){
                        String tvd= request.getParameter("D"+temp);
                        vdb.addWordForWord(tv,spra.getSprachID(),lec.getLectureID(),temp,tvd);
                    }
                }
            }catch(Exception ee){
            }
        ...
        String sparS=(String)session.getAttribute("sprach");
        v=(Vector)session.getAttribute("vocalr");
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="wrapper" style="padding-left: 17.5%; padding-right: 17.5%;">
                    ...
                    <div class="row">
                        <form style="width: 100%;" name="form1" method="post" action="wizard" onSubmit="MM_validateForm('txtName','','R','txtAddress','','R','txtTelephone','','R','txtPostCode','','RisNum','txtCity','','R','txtCountry','','R','txtEmail','','RisEmail');return document.MM_returnValue">
                            <table width="100%" border="0" cellpadding="1" cellspacing="1">
                                <tr bgcolor="657A9A">
                                    <td colspan="3">
                                        <div align="center"><b><font color="#FFFFFF">&Uuml;bersetzen</font></b></div>
                                    </td>
                                </tr>
                                <tr bgcolor="657A9A">
                                    <td width="13%"><b><font size="2" color="#FFFFFF">Deutsch</font></b></td>
                                    <td width="35%"><b><font size="2" color="#FFFFFF"><%=lan%></font></b></td>
                                    <td width="52%"><font size="2" color="#FFFFFF"><b>Beschreibung</b></font></td>
                                </tr>
                                <%
                                ...
                                %>
                                <tr>
                                    <td width="13%" bgcolor="AEBACD"><font size="2" color="#000033"><%=vo.getWord()%></font></td>
                                    <td bgcolor="AEBACD" width="35%"><font size="2" color="#000033">
                                        <input type="text" name="<%=vo.getWordTrack()%>">
                                    </font></td>
                                    <td bgcolor="AEBACD" width="52%">
                                        <input type="text" name="<%=besc%>">
                                    </td>
                                </tr>
                                <%
                                    }
