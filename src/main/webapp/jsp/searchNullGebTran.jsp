...
<%
    ...
    Vector vec= systemUserDao.getAllSystemUserWOTeacher();
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="wrapper" style="padding-left: 17.5%; padding-right: 17.5%;">
                    ...
                    <div class="row">
                        <form style="width: 100%;" name="form1" method="post" action="showNullGebTran" onSubmit="MM_validateForm('tranNo','','NisNum');return document.MM_returnValue">
