...
<head>
    ...
    <script>
        ...
        {
            window.location="EmailView";
        }
        function interested(){
            window.location="consultantInterestedListe?";
            //window.location="driveControler.jsp?folder="+document.form1.f.value+"&myPath="+document.form1.p.value;
        }

        function newconsultant(){
            window.location="newConsultantForm";
        }
        function composeMail(){
            document.form1.action="consultantEmailList";
...
<%
    ...
    Vector v=consultantDB.getAllConsultant();
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="wrapper" style="margin-bottom: 5px; float:right;">
                                ...
                                <a style="margin-right: 5px;" class="btn btn-primary" href="#" onclick="emailFormat()">Email Format</a>
                                <a style="margin-right: 5px;" class="btn btn-primary" href="#" onclick="newconsultant()">Neues Land</a>
                                        ...
                                        <table width="100%" border="0" cellpadding="1" cellspacing="1">
                                            <tr bgcolor="657A9A">
                                                <td colspan="5" height="16">
                                                    <div align="center"><b><font color="#FFFFFF">Consultantliste </font></b></div>
                                                </td>
                                            </tr>
                                            <tr bgcolor="#405579">
                                                ...
                                                <td width="25%" bgcolor="657A9A"><strong><B><FONT color=#ffffff size=2>Zahl der Agenturen</FONT></B></strong></td>
                                            </tr>
                                            <%
                                                for(int i=0;i<v.size();i++)
                                                {
                                                    ...
                                                    num=studentDB.getAllStudentConsultant(werbung.getConsultantID());

                                            %>
                                            <tr bgcolor="AEBACD">
                                                <td height="6"><font size="2" color="#000033"><font size="2" color="#000033"><a href="consultantUpdateForm?consultantid=<%=werbung.getConsultantID()%>"><%=werbung.getConsultantCountry()%></a></font></font></td>
                                                <td width="19%" height="6"><font size="2" color="#000033"><%=werbung.getConsultantPlace()%></font></td>
                                                <td height="6" bgcolor="AEBACD"><font size="2" color="#000033"><%=werbung.getConsultantOrg()%></font></td>
                                                <td height="6" bgcolor="AEBACD"><font size="2" color="#000033"><%=MyDate.formateDate(werbung.getConsultantDate(),MyDate.NUMERIC,MyDate.DEUTSCH)%></font></td>
                                                <td height="6" bgcolor="AEBACD"><font size="2" color="#000033"><%=num.size()%></font></td>
                                            </tr>
