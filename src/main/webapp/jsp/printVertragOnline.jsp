...
<%
    ...
    //rps.student.CourseRegistration cr=(rps.student.CourseRegistration)session.getAttribute("cr");
...
<table width="100%" border="0">
    ...
    <tr>
        <td colspan="6"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2">&sect;1) Zahlung</font></b><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><br>
            Die Kursgeb&uuml;hren sind sp&auml;testens am zweiten Teilkurstag f&auml;llig. Eine versp&auml;tete Zahlung kann durch eine Mahngeb&uuml;hr belastet werden. Die Kosten f&uuml;r weitere Zahlungsaufforderung durch die Rechtsabteilung hat der Kursteilnehmer zu tragen.</font> </td>
    </tr>
    <tr>
        <td colspan="6">&nbsp;</td>
    </tr>
    <tr>
        <td colspan="6"><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif">&sect;2) Zahlung / Abmeldung</font></b><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><br>
            Die K&uuml;ndigung einer Kursstufe kann nur 15 Tage vor Beginn der jeweiligen Stufe schriftlich und mit der Einzahllung der K&uuml;ndigungsgeb&uuml;hr von 100 Euro erfolgen. Erfolgt keine Zahlung bei der K&uuml;ndigung, gilt die K&uuml;ndigung als unwirksam. </font><font size="2"> </font> </td>
    </tr>
    <tr>
        <td colspan="6">&nbsp;</td>
    </tr>
